...
module "web" {
  source       = "git@github.com:deathtumble/terraform_modules.git//modules/web?ref=v0.1.41"
...
module "cloudfront_pipeline" {
  source                         = "git@github.com:deathtumble/terraform_modules.git//modules/cloudfront_pipeline?ref=v0.1.41"
